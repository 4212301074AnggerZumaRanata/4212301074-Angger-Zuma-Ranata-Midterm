...
print("Nama : Angger Zuma Ranata")
print("Nim : 4212301074")
print("Kelas : Mekatronika 5C Pagi\n")
...
def plot_confusion_matrix(y_true, y_pred, kernel_name):
    ...
    sns.heatmap(cm, annot=True, fmt='d', cmap='Greens', # <--- PERUBAHAN DI SINI
...
#1. Persiapan Data: Memuat dan Menyeimbangkan Sampel
...
#3. Tuning Parameter Cepat (K-Fold CV) 
def tune_parameters(X_features, y_labels, param_grid):
    ...
    #GridSearchCV sudah otomatis menampilkan progress karena verbose=1
...
if __name__ == "__main__":
    ...
    if not os.path.exists(FILE_PATH):
        ...
        if RUN_LOOCV_FINAL:
            ...
            write_log("\n--- EKSEKUSI PROGRAM SELESAI DILAKUKAN---")